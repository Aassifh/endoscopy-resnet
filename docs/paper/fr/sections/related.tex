...
I-JEPA~\cite{assran2023ijepa} repose sur des Vision Transformers ; nous employons un \emph{CNN-JEPA} avec prédicteur convolutif sur cartes de features, plus adapté au déploiement léger qu'un foundation model ViT.
Des travaux proches incluent BYOL~\cite{grill2020byol}.
Le pré-entraînement JEPA coloscopique sur CNN reste, à notre connaissance, non couvert.
