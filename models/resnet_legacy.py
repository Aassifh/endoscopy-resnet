"""Shared ResNet-50 architecture for training and inference."""
...
ARCH_NAME = "resnet50_from_scratch"
...
class ResNet(nn.Module):
    def __init__(self, block, layers, num_classes=2, zero_init_residual=False, norm_layer=None):
        super().__init__()
        if norm_layer is None:
            norm_layer = nn.BatchNorm2d
...
def resnet50_from_scratch(num_classes: int = 4, **kwargs) -> ResNet:
